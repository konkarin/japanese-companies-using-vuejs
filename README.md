...
| [株式会社スマートラウンド](https://jp.smartround.com/) | 2025-02-21 | [@ricky](https://github.com/rikipedia-5r) | スタートアップと投資家のためのデータ作成・管理プラットフォーム SaaS 「smartround」を提供する、スタートアップのためのスタートアップです。フロントエンド開発に Vue.js を採用し開発を行っています。エンジニア募集中です！ |